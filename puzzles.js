...
const PUZZULAR = [
  ...
  },
  {
    ...
    step: 2,
    title: 'Lego Chain 2',
    location_hint: 'LEGO STATION - QR #2 is right next to the Lego sets',
  ...
  },
  {
    ...
    step: 3,
    title: 'Lego Chain 3',
    location_hint: 'LEGO STATION - QR #3 is on the Lego table',
  ...
  // User will set actual hiding spots. Each puzzle gives letters.
  {
    ...
    step: 1,
    title: 'Hidden Hunt 1',
    location_hint: 'Under the shelf, under the metal car',
  ...
  },
  {
    ...
    step: 2,
    title: 'Hidden Hunt 2',
    location_hint: 'In the TARDIS cabinet',
  ...
  },
  {
    ...
    step: 2,
    title: 'Word Puzzle 2',
    location_hint: 'JIGSAW STATION - QR #2 is at the coffee table',
  ...
  },
  {
    ...
    step: 3,
    title: 'Word Puzzle 3',
    location_hint: 'JIGSAW STATION - QR #3 is near the TV',
  ...
  },
  {
    ...
    step: 2,
    title: 'Riddle 2',
    location_hint: 'PUZZLE BOX STATION - QR #2 is behind the couch',
  ...
  },
  {
    ...
    step: 3,
    title: 'Riddle 3',
    location_hint: 'PUZZLE BOX STATION - QR #3 is on the bookshelf',
